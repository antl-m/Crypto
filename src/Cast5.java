...
public class Cast5
{
     ...
     */
    private static final byte[] KAT_KEY = "0123456712".getBytes();
    private static final byte[] KAT_PT = "0123456789ABCDEF".getBytes();
    private static final byte[] KAT_CT = "7AC816D16E9B302E".getBytes();
     ...
     *
     *
     * 1. (key schedule) Compute 16 pairs of subkeys {Kmi, Kri} from a user
     ...
     *
     *   3.1 Li = Ri-1;
     *   3.2 Ri = Li-1 ^ F(Ri-1,Kmi,Kri), where F is defined in method F() --
